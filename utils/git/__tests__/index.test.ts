...
//     const GitApi = proxyquire('../src/git-api', {
//         'git-remote-origin-url': () => 'git@github.com:test-org/want-js-plugin.test.git',
//     });
...
//     const GitApi = proxyquire('../src/git-api', {
//         'git-remote-origin-url': () => 'https://github.com/test-org/want-js-plugin.test.git',
//     });
//     const actual = await GitApi.getParsedRemoteOriginUrl();
//     const expected = {
//         protocol: 'https',
...
//     const GitApi = proxyquire('../src/git-api', {
//         'git-remote-origin-url': () => 'https://username@bitbucket.org/test-org/want-js-plugin.test.git',
//     });
//     const actual = await GitApi.getParsedRemoteOriginUrl();
//     const expected = {
//         protocol: 'https',
...
//     const GitApi = proxyquire('../src/git-api', {
//         'git-remote-origin-url': () => 'git@bitbucket.org:test-org/want-js-plugin.test.git',
//     });
//     const actual = await GitApi.getParsedRemoteOriginUrl();
//     const expected = {
//         protocol: 'git',
...
//     const GitApi = proxyquire('../src/git-api', {
//         'git-remote-origin-url': () => 'git@github.any-site.org:test-org/want-js-plugin.test.git',
//     });
//     const actual = await GitApi.getParsedRemoteOriginUrl();
//     const expected = {
//         protocol: 'git',
...
//                 },
//             }],
//             revparse: async () => ' some_branch_name\n',
//         }),
//         '@octokit/rest': FakeGitHub,
//         'git-remote-origin-url': () => 'https://github.com/user/want-js-plugin.test.git',
//     });
//
//     const gitApi = new GitApi('github.com');
